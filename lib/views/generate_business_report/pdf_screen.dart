...
import 'package:kiosk/views/generate_business_report/generate_pdf.dart';
  ...
  getPdfData() async {
    try {
      final res = await context
          .read<UserRepository>()
          .generatedBusinessPlansGetData(widget.id);

      final file = await generatePDF(res, getCurrency(context));
